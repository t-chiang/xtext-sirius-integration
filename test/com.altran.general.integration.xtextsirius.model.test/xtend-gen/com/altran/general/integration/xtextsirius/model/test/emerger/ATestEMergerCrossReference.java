...
public abstract class ATestEMergerCrossReference<T extends IElement<T>> extends ATestEMergerEReference<T> {
  ...
  public void set_bagEmpty() {
    ...
    final T existing = ObjectExtensions.<T>operator_doubleArrow(_createRootElement, _function);
    final T result = this.createEMerger(existing, this.xtextSiriusTestPackage.getAElement_ChangeableBagRef()).merge(ImmutableSet.<T>of(this.newEdited(3, "3.14"), this.newEdited(2, "2.71")), this.xtextSiriusTestPackage.getAElement_ChangeableBagRef());
    Assert.assertEquals(2, result.getChangeableBagRef().size());
    Assert.assertTrue(this.valueExists(result.getChangeableBagRef(), "a3.14"));
    Assert.assertTrue(this.valueExists(result.getChangeableBagRef(), "a2.71"));
  }
  ...
  public void set_bagPartiallyExisting() {
    ...
    final T existing = ObjectExtensions.<T>operator_doubleArrow(_createRootElement_1, _function_1);
    final T result = this.createEMerger(existing, this.xtextSiriusTestPackage.getAElement_ChangeableBagRef()).merge(ImmutableSet.<T>of(IterableExtensions.<T>head(edited.getChangeableBagRef()), this.newEdited(2, "2.71")), this.xtextSiriusTestPackage.getAElement_ChangeableBagRef());
    Assert.assertEquals(2, result.getChangeableBagRef().size());
    Assert.assertTrue(this.valueExists(result.getChangeableBagRef(), "a2.71"));
    Assert.assertTrue(this.valueExists(result.getChangeableBagRef(), "a3.14"));
  }
  ...
  public void set_listEmpty() {
    ...
    final T existing = ObjectExtensions.<T>operator_doubleArrow(_createRootElement, _function);
    final T result = this.createEMerger(existing, this.xtextSiriusTestPackage.getAElement_ChangeableListRef()).merge(ImmutableSet.<T>of(this.newEdited(3, "3"), this.newEdited(2, "2")), this.xtextSiriusTestPackage.getAElement_ChangeableListRef());
    Assert.assertEquals(2, result.getChangeableListRef().size());
  ...
  public void set_listPartiallyExisting() {
    ...
    final T existing = ObjectExtensions.<T>operator_doubleArrow(_createRootElement_1, _function_1);
    final T result = this.createEMerger(existing, this.xtextSiriusTestPackage.getAElement_ChangeableListRef()).merge(ImmutableSet.<T>of(IterableExtensions.<T>head(edited.getChangeableListRef()), this.newEdited(2, "2")), this.xtextSiriusTestPackage.getAElement_ChangeableListRef());
    Assert.assertEquals(2, result.getChangeableListRef().size());
    Assert.assertTrue(this.valueExists(result.getChangeableListRef(), "a3"));
    Assert.assertTrue(this.valueExists(result.getChangeableListRef(), "a2"));
  }
